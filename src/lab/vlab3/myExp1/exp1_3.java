...
public class exp1_2 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "OUTPUT", "Current_src ", "Inductor ", // 10, 11 , 12
...
//				end_index++;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            Double get_length() {
                ...
                double d = Double.parseDouble(str);//Double.valueOf(str.trim()).doubleValue();
            ...
            Double get_capacitance() {
                String str = capacitance.toString(); 
                double d = Double.parseDouble(str);//Double.valueOf(str.trim()).doubleValue();
                return d;
...
////////			int no_values = 100 ;
            ...
            public void make_graph() {
                int incr = 0;
                double W = Pmos_w;//240;//Double.parseDouble(Pmos_w);//Double.valueOf(Pmos_w.trim()).doubleValue();
                double L = Pmos_l;//180;//Double.parseDouble(Pmos_l);//Double.valueOf(Pmos_l.trim()).doubleValue();
                double MuCox = .0001;
                double Id = Current;//Double.parseDouble(Current);//Double.valueOf(Current.trim()).doubleValue();
...
//			bottom.add(h );
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (Pmos_l != 0.0 && Pmos_w != 0.0 && Nmos_l != 0.0 && Nmos_w != 0.0 && Current!=0.0 && Voltage!=0.0) {
                    //		callJS();
                    URL php_file = null;
