...
fwrite($f , "M1 a c b gnd NMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "M2 c a b gnd NMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "Ib b gnd 1m\n");
fwrite($f , "L1 vdd a 1n\n");
fwrite($f , "L1 vdd c 1n\n");
fwrite($f , "D1 d a test\n");
fwrite($f , "D1 d c test\n");
fwrite($f , "Vdd Vdd 0 1.8\n");
fwrite($f , ".param ctr=0.1\n");
fwrite($f , "vctrl d gnd ctr\n");
fwrite($f , ".tran 0.1ns 0.6us 0.595us\n");
fwrite($f , ".save v(c) V(in)\n");
fwrite($f , ".end\n");
fclose($f);
echo "Done";
//-----------------------------------------------------
