...
public class exp1 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "OUTPUT", "Current Src ", "Resistor ", // 10, 11 , 12
        ...
        public class node {
		 ...
		 else if (img == 2 || img == 9 || img == 4 || img == 10) // ground , VDD , INPUT , OUTPUT
                {
                    ...
                    for (int i = end_pointsX[0] - 4; i < end_pointsX[0] + 5; i++) {
                        for (int j = end_pointsY[0] - 4; j < end_pointsY[0] + 5; j++) {
                            if (img == 2) // ground
                            {
                                end_points_mat[i][j] = 7+3-2;
                            } else if (img == 9) //vdd
                            {
                                end_points_mat[i][j] = 8+3-2;
                            } else if (img == 4) {
                                //	System.out.println("HI shashnak");
                                //	System.out.println(img);

                                end_points_mat[i][j] = 9+3-2;
                            } else {
                                end_points_mat[i][j] = 10+3-2;
                            }
                        }
                    }
            ...
            public void make_end_points(int img) {
                ...
                } else if (img == 8 || img == 12 || img == 5 || img == 6) // Capacitor
                {
                    count_end_points = 2;
                    int a, b, c, d;
                    a = 0;
...
//				end_index++;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            public myDialog(JFrame fr, String comp, int node_no) {
                ...
                if (comp_node[node_no].img_no == 12) // resistor 
                {
                    ...
                    JLabel r = new JLabel("Select the Resistance :");
                    JLabel r_unit = new JLabel("ohm");
                ...
                } else if (comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9) // terminal
                {
                    ...
                    SpinnerModel acVol_model = new SpinnerNumberModel(500, //initial value
                            0, //min
                            1000, //max
                            1);  //step
                    ...
                    del.addActionListener(this);
                    rotate.addActionListener(this);
                } else if (comp_node[node_no].img_no == 1 || comp_node[node_no].img_no == 7)// NMOS chip 
                {
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                if (img_button_pressed == -1) // for selecting anything on work panel
                {
                    ...
                    } else if (work_mat[work_x][work_y] != -1) // there is a comp on (work_x , work_y) here temp rep inder of comp_nodearray
                    {
                        ...
                        if (temp1 == 1 || temp1 == 7 || temp1 == 8 || temp1 == 2 || temp1 == 9 || temp1 == 12 || temp1 == 5 || temp1 == 6) {
                ...
                } else // For adding comp 
                {
                    ...
                    } else if (img_button_pressed == 8 || img_button_pressed == 12 || img_button_pressed == 5 || img_button_pressed == 6) // capicitor  
                    {
                ...
                for (i = 0; i < total_comp; i++) {
                    if (comp_node[i].del != true) {
                        if (comp_node[i].img_no == 1) {
                            ...
                            g.setColor(Color.white);
                            g.drawString(comp_str[12], comp_node[i].node_x + 30, comp_node[i].node_y + 50);
...
//			JLabel wave_head = new JLabel("This is the wave simulation output");
	    ...
	    JPanel notes = new JPanel();
           ...
           // notes.add(note_head, BorderLayout.NORTH);
            ...
            Dimension dim = new Dimension(390, 250);
            jTextField1.setPreferredSize(dim);
            // Add label to west
            //notes.add(jTextField1, BorderLayout.NORTH);
            //jTextField1.setLineWrap(true);
            //jTextField1.setBorder(BorderFactory.createLineBorder( Color.black));
            jTextField1.setFont(new Font("Papyrus",Font.PLAIN,18));//
                    //"Monospaced", Font.PLAIN,14));
           // jTextField1.setWrapStyleWord(true);
            jTextField1.append(" The small signal voltage gain of the\n common source amplifier is given by\n\n Ux*Cox*(W/L)1*(Vgs1-Vth1)\n --------------------------------------\n Up*Cox*(W/L)2*|Vgs2-Vth2|\n\n This experiment shows the variation in\n the gain with respect to aspect ratio and\n the load resistance."); 
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 >Design and characterization of common-source amplifier with Diode connected Load </FONT></html>", JLabel.CENTER);
...
//			bottom.add(h );
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (true){//Nmos_l != null && Nmos_w != null && Capacitance != null && Resistance != null && DC_vol != null && AC_vol != null && AC_freq != null && circuit_check()) {//////////////////////////////////////////
                    //		callJS();
                    URL php_file = null;
                    URLConnection c = null;
                    String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Resistance + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq+"_"+Pmos_l+"_"+Pmos_w);
                    URL CGIurl = null;
                    try {
                        if (exp_type == 0) {
