                    ...
                    for (int i = end_pointsX[0] - 4; i < end_pointsX[0] + 5; i++) {
                        for (int j = end_pointsY[0] - 4; j < end_pointsY[0] + 5; j++) {
                            ...
                            } else if (img == 9) //vdd
                            {
                                ...
                                end_points_mat[i][j] = 9+1;
                            } else {
                                end_points_mat[i][j] = 10+1;
                            }
                        }
                    }
...
// setting work panel -----------------------------------
            ...
            for (i = 1; i <= 6; i++) {
                java.net.URL imgURL = getClass().getResource("images2/comp" + i + ".gif");
                if (imgURL != null) {
            ...
            for (i = 1; i <= 6; i++) {
                ...
                java.net.URL imgURL = getClass().getResource("images2/comp" + j + ".gif");
                if (imgURL != null) {
            ...
            URL selected_URL = getClass().getResource("images2/comp" + 0 + ".gif");
            ...
            toolPanelDown.setBackground(Color.yellow);
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 >Design and characterization of common-source amplifier with Current Source Load </FONT></html>", JLabel.CENTER);
