...
public class exp1 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "OUTPUT", "Current Src ", "2nd PMOS ", // 10, 11 , 12
...
System.out.println("Idhar paunch gaya");
		...
		g2d.setColor(Color.black);
                /*for (i = 0; i < no_values - 1; i += 15) {
                    ...
                    g2d.drawString(strPre(time[i] * 100), 40 + 2 * i, 450);
                }

                for (i = 0; i < no_values - 1; i += 10) {
                    DecimalFormat df = new DecimalFormat("##.## ");
                    g2d.drawString(strPre(V_out[i] * 100), 40, 400 - 2 * i);
                }*/
		...
		for(i=0;i<15;i++)
		{
			g2d.drawString(strPre(V_out[1]*100+2*(i+1)),25,450-30*(i+1));
		}
		for(i=0;i<15;i++)
		{
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 > Design and characterization of common-gate amplifier</FONT></html>", JLabel.CENTER);
