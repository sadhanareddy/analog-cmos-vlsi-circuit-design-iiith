...
System.out.println("Idhar paunch gaya");
                ...
                /*for (i = 0; i < no_values - 1; i += 15) {
                    ...
                    g2d.drawString(strPre(time[i] *1000), 40 + 2 * i, 450);
                }

                for (i = 0; i < no_values - 1; i += 15) {
                    DecimalFormat df = new DecimalFormat("##.## ");
                    g2d.drawString(strPre(V_out[i] * 10), 40, 40 + 2 * i);
                }*/
                // g2d.drawString("Output Voltage ", 280, 260);

		for(i=0;i<10;i++)
		{
			g2d.drawString(strPre((time[1]*100)+1*(i+1)),40+30*(i+1),450);
		}
		for(i=0;i<10;i++)
		{
		...
		for(i=0;i<15;i++)
		{
			g2d.drawString(strPre(V_out[1]*10+1*(i+1)),25,450-30*(i+1));
		}
		for(i=0;i<15;i++)
		{
			g2d.drawLine(35,450-30*(i+1),40,450-30*(i+1));
                ...
                g2d.setColor(Color.blue);
                g2d.drawString("Vin (volt) --> ", 160, 460);
                g2d.drawString("Vout ", 5, 200);
...
// setting work panel -----------------------------------
            ...
            for (i = 1; i <= 6; i++) {
                ...
                //img_button1[i].setPreferredSize(new Dimension(25,25));
            ...
            URL selected_URL = getClass().getResource("images3/comp" + 0 + ".gif");
...
//Setting Top Panel ========================================================================== 
            ...
            java.net.URL imgURL = getClass().getResource("images3/simulate1.png");
            java.net.URL imgURL2 = getClass().getResource("images3/graph.gif");
...
//			bottom.add(h );
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (/*Nmos_l != null && Nmos_w != null && Capacitance != null && Resistance != null && DC_vol != null && AC_vol != null && AC_freq != null &&*/ circuit_check()) {
                    //		callJS();
                    URL php_file = null;
