...
public class exp1 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "3rd NMOS", "PMOS", "Vdd ", // 7 , 8 , 9 
            "4th NMOS", "Current Src ", "2nd PMOS ", // 10, 11 , 12
	...
	String Nmos_l_4 = "180n";
        ...
        String Pmos_l = "180n";// Actually PMOS
	String Pmos_l_2 = "180n"; // Actually 2nd PMOS
	String Pmos_w = "50000n";
	String Pmos_w_2 = "50000n";
        String AC_vol = "10";
        String AC_freq = ".5G";
        String DC_vol = ".9";
        String current = "1";
		...
		if (img == 11) // pmos
            ...
            public void make_end_points(int img) {
                if (img == 1 || img == 7 || img == 10 || img == 4 || img == 8 || img == 12) // C/NMOS 
                {
                    count_end_points = 3;
                ...
                } else if (img == 5 || img == 6 || img == 11) // Capacitor
                {
                    count_end_points = 2;
                    int a, b, c, d;
                    a = 0;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            /*    if (comp_node[node_no].img_no == 8 || comp_node[node_no].img_no == 12)  
                ...
                } else if (comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9) // terminal
                {
                    ...
                    del.addActionListener(this);
                    rotate.addActionListener(this);
                } else if (comp_node[node_no].img_no == 1 || comp_node[node_no].img_no == 7 || comp_node[node_no].img_no == 10 || comp_node[node_no].img_no == 4 || comp_node[node_no].img_no == 8 || comp_node[node_no].img_no == 12)// NMOS chip 
                {
...
//					wire[total_wire-1 ].update2((work_x/20)*20 , (work_y/20)*20);
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                } else // For adding comp 
                {
                    ...
                    if (img_button_pressed == 1 || img_button_pressed == 7 || img_button_pressed == 10 || img_button_pressed == 4 || img_button_pressed == 8 || img_button_pressed == 12) // cmos or nmos 
                    {
                    ...
                    } else if (img_button_pressed == 5 || img_button_pressed == 6 || img_button_pressed == 11 ) // capicitor  
                    {
...
System.out.println("Idhar paunch gaya");
		...
		for(i=0;i<10;i++)
		{
			g2d.drawString(strPre(10*(i+1)),40+30*(i+1),450);
		}
		for(i=0;i<10;i++)
		{
		...
		for(i=0;i<15;i++)
		{
			g2d.drawString(strPre(.1*(i+1)),21,450-30*(i+1));
		}
		for(i=0;i<15;i++)
		{
			g2d.drawLine(35,450-30*(i+1),40,450-30*(i+1));
                ...
                g2d.setColor(Color.blue);
                g2d.drawString("f (MHz) --> ", 160, 460);
                g2d.drawString("Vdb ", 2, 200);
                g2d.drawString("(V) ", 2, 213);
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 > Design and characterization of a differential to single ended conversion circuit </FONT></html>", JLabel.CENTER);
...
//			bottom.add(h );
        ...
        public boolean circuit_check() {
            int check_points_value[][] = new int[26][10]; // each index will store corresponding  component for points of (comp point no -> index )
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (Nmos_l != null && Nmos_w != null  && DC_vol != null && AC_vol != null && AC_freq != null && circuit_check()) {
                    //		callJS();
                    URL php_file = null;
                    URLConnection c = null;
                    String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Pmos_l + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq + "_" + Nmos_l_2 + "_" + Nmos_w_2 + "_" + Nmos_l_3 + "_" + Nmos_w_3 +"_"+Nmos_l_4+"_"+Nmos_w_4+"_"+Pmos_w +"_"+Pmos_l_2+"_"+Pmos_w_2);
                    URL CGIurl = null;
                    try {
                        if (exp_type == 0) {
