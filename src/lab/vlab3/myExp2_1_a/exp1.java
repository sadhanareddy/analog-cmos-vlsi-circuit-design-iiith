...
//				end_index++;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            public myDialog(JFrame fr, String comp, int node_no) {
                ...
                {
                    SpinnerModel dc_model = new SpinnerNumberModel(1, //initial value
                            0, //min
                            1.8, //max
                            0.1);  //step
                    JLabel comp_name = new JLabel("<html><font size=4><b>" + comp + "</b></font></html>");//,icon[icon_no],JLabel.CENTER);
...
//			JLabel wave_head = new JLabel("This is the wave simulation output");
            ...
            //jTextField1.append(" The small signal voltage gain of\n the common source amplifier is given by\n\n Av=-Gm*Rd\n\n This experiment shows the variation in\n the gain with respect to aspect ratio and\n the load resistance.");
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 >Design and characterization of common-source amplifier with Resistive Load </FONT></html>", JLabel.CENTER);
...
//			bottom.add(h );
        ...
        public void actionPerformed(ActionEvent e) {
		   ...
		   /* java.net.URL uri2;
                    try {
                        uri2 = new java.net.URL("file:///var/www/vlab/mytest/img.html");
