...
public class exp1 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "NMOS ", "Ground Terminal ", " Wire ", // 1, 2 , 3
            "2nd NMOS ", "DC Vol ", "AC Vol ", // 4 , 5 ,6

            "3rd NMOS", "Resistor", "Vdd ", // 7 , 8 , 9 
            "4th NMOS", "Current Src ", "2nd Resistor ", // 10, 11 , 12
            "This is CMOS Chip No:1", "This is CMOS Chip No:1"};
        //*************************************************************************************************************************************
        //Circuit Component values which need to be send to ngspice ***************************************************************************
        String Nmos_l = "180n";
        String Nmos_l_2 = "180n";
        String Nmos_w = "90000n";
        String Nmos_w_2 = "30000n";
        String Nmos_l_3 = "180n";
        String Nmos_w_3 = "90000n";
	String Nmos_l_4 = "180n";
        String Nmos_w_4 = "90000n";
        String Capacitance = "1";//Actually current
        String Resistance_1 = "1000";
	String Resistance_2 = "1000"; 
        String AC_vol = "10";
        String AC_freq = ".5G";
        String DC_vol = ".9";
        String current = "1";
        ...
        public class node {
                ...
                } else if (img == 2 || img == 9 ) // ground , VDD , INPUT , OUTPUT
                {
                    ...
                    for (int i = end_pointsX[0] - 4; i < end_pointsX[0] + 5; i++) {
                        for (int j = end_pointsY[0] - 4; j < end_pointsY[0] + 5; j++) {
                            if (img == 2) // ground
                            {
                                end_points_mat[i][j] = 7+1;
                            } else if (img == 9) //vdd
                            {
                                end_points_mat[i][j] = 8+1;
                            } 
                        }
                    }
                } else if (img == 5) // DC Vol 
                {
                    for (int k = 0; k < 2; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k - 1+11;
                            }
                        }
                    }
                } else if (img == 6) // AC Vol
                {
                    for (int k = 0; k < 2; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k + 13-1;
                            }
                        }
                    }
                }
		
		else if (img == 10)// 2nd pmos
                {
                    for (int k = 0; k < 3; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k + 14;
                            }
                        }
                    }
		}
		else if (img == 4)// 2nd pmos
                {
                    for (int k = 0; k < 3; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k + 17;
                            }
                        }
                    }
		}
		else if (img == 11)// 2nd pmos
                {
                    for (int k = 0; k < 2; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k + 20;
                            }
                        }
                    }
		}

		else if (img == 12)// 2nd pmos
                {
                    for (int k = 0; k < 2; k++) {
                        for (int i = end_pointsX[k] - 4; i < end_pointsX[k] + 5; i++) {
                            for (int j = end_pointsY[k] - 4; j < end_pointsY[k] + 5; j++) {
                                end_points_mat[i][j] = k + 22;
                            }
                        }
                    }
		}
            ...
            public void make_end_points(int img) {
                if (img == 1 || img == 7 || img == 10 || img == 4) // C/NMOS 
                {
                    count_end_points = 3;
                ...
                } else if (img == 8 || img == 5 || img == 6 || img == 11 || img == 12) // Capacitor
                {
                    count_end_points = 2;
                    int a, b, c, d;
                    a = 0;
            ...
            public void update_mat(int index) // update the matrix value to work_mat // index is the index of the node_comp matrix
            {
                int i, j;
                for (i = node_x;;) {
                    if (virtual_w > 0 && i >= node_x + virtual_w) {
                        break;
                    } else if (virtual_w < 0 && i <= node_x + virtual_w) {
                        break;
                    }

                    for (j = node_y;;) {
                        if (virtual_h > 0 && j >= node_y + virtual_h) {
                            break;
                        } else if (virtual_h < 0 && j <= node_y + virtual_h) {
                            break;
                        }
...
//				end_index++;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            public myDialog(JFrame fr, String comp, int node_no) {
                ...
                if (comp_node[node_no].img_no == 11) // current 
                {
                    SpinnerModel capacitance_model = new SpinnerNumberModel(1, //initial value
                            0, //min
                            10, //max
                            0.1);  //step
                    ...
                    JLabel c = new JLabel("Select the Current :");
                    JLabel c_unit = new JLabel("milliAmpere");
                ...
                if (comp_node[node_no].img_no == 8 || comp_node[node_no].img_no == 12)  
                {
                    SpinnerModel resistance_model = new SpinnerNumberModel(2000, //initial value
                            0, //min
                            10000, //max
                            1);  //step
                    JLabel comp_name = new JLabel("<html><font size=4><b>" + comp + "</b></font></html>");//,icon[icon_no],JLabel.CENTER);
                    ...
                    resistance = new JSpinner(resistance_model);
                    JLabel r = new JLabel("Select the Current :");
                    JLabel r_unit = new JLabel("milliAmpere");
                    ...
                    layout.putConstraint(SpringLayout.NORTH, r, 60, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, resistance, 20, SpringLayout.EAST, r);
                    layout.putConstraint(SpringLayout.NORTH, resistance, 60, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, r_unit, 10, SpringLayout.EAST, resistance);
                    layout.putConstraint(SpringLayout.NORTH, r_unit, 60, SpringLayout.NORTH, cp);
                ...
                if (comp_node[node_no].img_no == 5) // DC voltage 
                {
                    SpinnerModel dc_model = new SpinnerNumberModel(.9, //initial value
                            0, //min
                            1.8, //max
                            0.05);  //step
                    JLabel comp_name = new JLabel("<html><font size=4><b>" + comp + "</b></font></html>");//,icon[icon_no],JLabel.CENTER);
                    ...
                    dc_vol = new JSpinner(dc_model);
                    JLabel dc = new JLabel("Select the DC Voltage :");
                    JLabel dc_unit = new JLabel("volt");

                    del = new JButton("Delete Component");
                    ok = new JButton("O.K");
                    rotate = new JButton("Rotate");

                    layout.putConstraint(SpringLayout.WEST, dc, 20, SpringLayout.WEST, cp);
                    layout.putConstraint(SpringLayout.NORTH, dc, 60, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, dc_vol, 20, SpringLayout.EAST, dc);
                    layout.putConstraint(SpringLayout.NORTH, dc_vol, 60, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, dc_unit, 10, SpringLayout.EAST, dc_vol);
                    layout.putConstraint(SpringLayout.NORTH, dc_unit, 60, SpringLayout.NORTH, cp);
                ...
                } else if (comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9) // terminal
                {
                ...
                } else if (comp_node[node_no].img_no == 6) {
                    SpinnerModel acVol_model = new SpinnerNumberModel(10, //initial value
                            0, //min
                            1000, //max
                            1);  //step
                    SpinnerModel freq_model = new SpinnerNumberModel(0.5, //initial value
                            0, //min
                            1, //max
                            0.1);  //step
                    ...
                    ac_vol = new JSpinner(acVol_model);
                    ac_freq = new JSpinner(freq_model);

                    JLabel acVol = new JLabel("Select the AC voltage :");
                    JLabel acVol_unit = new JLabel("milliVolt");
                    del = new JButton("Delete Component");
                    ok = new JButton("O.K");
                    rotate = new JButton("Rotate");

                    layout.putConstraint(SpringLayout.WEST, acVol, 20, SpringLayout.WEST, cp);
                    layout.putConstraint(SpringLayout.NORTH, acVol, 50, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, ac_vol, 20, SpringLayout.EAST, acVol);
                    layout.putConstraint(SpringLayout.NORTH, ac_vol, 50, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, acVol_unit, 10, SpringLayout.EAST, ac_vol);
                    layout.putConstraint(SpringLayout.NORTH, acVol_unit, 50, SpringLayout.NORTH, cp);

                    JLabel freq = new JLabel("Select the Frequency :");
                    JLabel freq_unit = new JLabel("Gigahertz");

                    layout.putConstraint(SpringLayout.WEST, freq, 20, SpringLayout.WEST, cp);
                    layout.putConstraint(SpringLayout.NORTH, freq, 80, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, ac_freq, 20, SpringLayout.EAST, freq);
                    layout.putConstraint(SpringLayout.NORTH, ac_freq, 80, SpringLayout.NORTH, cp);

                    layout.putConstraint(SpringLayout.WEST, freq_unit, 10, SpringLayout.EAST, ac_freq);
                    layout.putConstraint(SpringLayout.NORTH, freq_unit, 80, SpringLayout.NORTH, cp);
                    ...
                    del.addActionListener(this);
                    rotate.addActionListener(this);
                } else if (comp_node[node_no].img_no == 1 || comp_node[node_no].img_no == 7 || comp_node[node_no].img_no == 10 || comp_node[node_no].img_no == 4)// NMOS chip 
                {
                    SpinnerModel length_model = new SpinnerNumberModel(180, //initial value
                            0, //min
                            1000, //max
                            1);  //step
                    SpinnerModel width_model = new SpinnerNumberModel(90000, //initial value
                            0, //min
                            100000, //max
                            1);  //step
            ...
            String get_DCvoltage() {
                return dc_vol.getValue().toString();
            }

            String get_resistance() {
                return resistance.getValue().toString();
            }

            String get_ACvoltage() {
                return ac_vol.getValue().toString();
            }

            String get_freq() {
                return ac_freq.getValue().toString();
            }

            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == ok) {
                    System.out.println("HI ok button is pressed ");
                    if (comp_node[node_index].img_no == 1) //NMOS
                    {
                        Nmos_l = get_length();
                        Nmos_w = get_width();
                    } else if (comp_node[node_index].img_no == 4) //NMOS
                    {
                        Nmos_l_2 = get_length();
                        Nmos_w_2 = get_width();
                    } else if (comp_node[node_index].img_no == 7) //3rd NMOS
                    {
                        Nmos_l_3 = get_length();
                        Nmos_w_3 = get_width();
                    } else if (comp_node[node_index].img_no == 10) //4th NMOS
                    {
                        Nmos_l_4 = get_length();
                        Nmos_w_4 = get_width();
                    }else if (comp_node[node_index].img_no == 8) //Resistance 
                    {
                        Resistance_1 = get_resistance();
                    } else if (comp_node[node_index].img_no == 12) //Resistance 
                    {
                        Resistance_2 = get_resistance();
                    }else if (comp_node[node_index].img_no == 11) //Current
                    {
                        Capacitance = get_capacitance();
                    } else if (comp_node[node_index].img_no == 5) //DC Vol 
                    {
                        DC_vol = get_DCvoltage();
                    } else if (comp_node[node_index].img_no == 6) 
                    {
                        AC_vol = get_ACvoltage();
                        AC_freq = get_freq();
                    }
                    setVisible(false);
                    workPanel.repaint();
                ...
                if (e.getSource() == del) {
                    ...
                    {
                        Nmos_l_2 = Nmos_w_2 = null;
                    } else if (comp_node[node_index].img_no == 7) //3rd NMOS
                    {
                        Nmos_l_3 = Nmos_w_3 = null;
                    } else if (comp_node[node_index].img_no == 10) //NMOS
                    {
                        Nmos_l_4 = Nmos_w_4 = null;
                    }else if (comp_node[node_index].img_no == 11) //Capacitor 
                    {
                        Capacitance = null;
                    } else if (comp_node[node_index].img_no == 8) //Resistance 
                    {
                    ...
                    {
                        Resistance_2 = null;
                    } else if (comp_node[node_index].img_no == 5) //Capacitor 
                    {
                        DC_vol = null;
                    } else if (comp_node[node_index].img_no == 6) //Capacitor 
                    {
                        AC_vol = AC_freq = null;
                    }
                    setVisible(false);
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                if (img_button_pressed == -1) // for selecting anything on work panel
                {
                    ...
                    } else if (work_mat[work_x][work_y] != -1) // there is a comp on (work_x , work_y) here temp rep inder of comp_nodearray
                    {
                        ...
                        if (temp1 == 1 || temp1 ==4 || temp1 == 10 || temp1 == 7 || temp1 == 8 || temp1 == 2 || temp1 == 9 || temp1 == 12 || temp1 == 5 || temp1 == 6 || temp1 == 11) {
                ...
                } else // For adding comp 
                {
                    ...
                    if (img_button_pressed == 1 || img_button_pressed == 7 || img_button_pressed == 10 || img_button_pressed == 4) // cmos or nmos 
                    {
                    ...
                    } else if (img_button_pressed == 8 || img_button_pressed == 5 || img_button_pressed == 6 || img_button_pressed == 11 || img_button_pressed == 12) // capicitor  
                    {
                ...
                for (i = 0; i < total_comp; i++) {
                    if (comp_node[i].del != true) {
                        if (comp_node[i].img_no == 1) {
                            ...
                            draw_nmos(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[4], comp_node[i].node_x - 10, comp_node[i].node_y + 10);
                        }else if (comp_node[i].img_no == 10) {
                            draw_nmos(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[10], comp_node[i].node_x - 10, comp_node[i].node_y + 10);
                            ...
                            draw_resistor(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            ...
                            //			g.fillOval( comp_node[i].end_pointsX[1] - 4, comp_node[i].end_pointsY[1]  -4, 8 ,8 );
                            //			g.setColor(Color.black);
                        } else if (comp_node[i].img_no == 12) {
                            draw_resistor(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[12], comp_node[i].node_x - 10, comp_node[i].node_y + 10);
                        } else if (comp_node[i].img_no == 5) {
                            draw_dc(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[5], comp_node[i].node_x + 30, comp_node[i].node_y + 50);
                        } else if (comp_node[i].img_no == 11) {
                            draw_current(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[11], comp_node[i].node_x + 30, comp_node[i].node_y + 50);
                        } else if (comp_node[i].img_no == 6) {
                            draw_ac(g2d, comp_node[i].node_x, comp_node[i].node_y, 20, comp_node[i].angle);
                            g.setColor(Color.white);
                            g.drawString(comp_str[6], comp_node[i].node_x + 30, comp_node[i].node_y + 50);
...
//				g.drawRect( x , y , 2*width , 4*width);
                ...
                g.drawLine(x + width + width / 4, y + width / 4 + width - 7, x + width + width / 4, y + (7 * width) / 4 + width + 7);
...
//				g.drawRect( x , y , 3*width , 2*width);
            ...
            void draw_resistor(Graphics2D g, int x, int y, int width, double angle) {
                g.rotate(angle, x, y);
                g.setColor(Color.yellow);
//				g.drawRect( x , y , 3*width , 2*width);
                g.drawString("R", x + (5 * width) / 4 + 1, y + width / 2 + 15);

                g.setColor(Color.green);
                g.setStroke(new BasicStroke(4));
                g.drawLine(x, y + width, x + (5 * width) / 4 - 3, y + width);
                g.drawLine(x + 3 * width, y + width, x + (7 * width) / 4 + 3, y + width);

                g.setStroke(new BasicStroke(2));
                g.drawLine(x + (5 * width) / 4, y + width / 2, x + (5 * width) / 4, y + (3 * width) / 2);
                g.drawLine(x + (5 * width) / 4, y + width / 2, x + (7 * width) / 4, y + width / 2);
                g.drawLine(x + (5 * width) / 4, y + (3 * width) / 2, x + (7 * width) / 4, y + (3 * width) / 2);
                //g.drawRect(x + (5 *width)/4, y + width, 20, 8);
                g.drawLine(x + (7 * width) / 4, y + width / 2, x + (7 * width) / 4, y + (3 * width) / 2);
                g.setStroke(new BasicStroke(4));
                // end points 
                g.setColor(Color.red);
...
//				g.drawRect( x , y , 2*width , 2*width);
            ...
            void draw_dc(Graphics2D g, int x, int y, int width, double angle) {
                g.rotate(angle, x, y);
                g.setColor(Color.yellow);
//				g.drawRect( x , y , 3*width , 2*width);
                ...
                g.setColor(Color.green);
                g.setStroke(new BasicStroke(4));
                g.drawLine(x, y + width, x + (4 * width) / 4, y + width);
                g.drawLine(x + 3 * width, y + width, x + (9 * width) / 4, y + width);

                g.drawOval(x + (4 * width) / 4, y + width - 12, 25, 25);
                g.drawLine(x + (5 * width) / 4, y + width, x + (6 * width) / 4, y + width);
                g.drawLine(x + (7 * width) / 4, y + width, x + (8 * width) / 4, y + width);
                g.drawLine(x + (7 * width) / 4 + 2, y + width - 3, x + (7 * width) / 4 + 2, y + width + 3);
                //	g.drawLine(x +(5*width)/4  , y + width /2, x + (5*width)/4 ,y + (3*width)/2);
                //	g.drawLine(x +(7*width)/4  , y + width /2, x + (7*width)/4 ,y + (3*width)/2);
                g.setStroke(new BasicStroke(4));
                // end points 
            ...
            void draw_ac(Graphics2D g, int x, int y, int width, double angle) {
                g.rotate(angle, x, y);
                g.setColor(Color.yellow);
//				g.drawRect( x , y , 3*width , 2*width);
                g.drawString("AC", x + 28, y + width + 5);
                g.setColor(Color.green);
                g.setStroke(new BasicStroke(4));
                g.drawLine(x, y + width, x + (4 * width) / 4, y + width);
                g.drawLine(x + 3 * width + 3, y + width, x + (9 * width) / 4 + 5, y + width);
                g.setStroke(new BasicStroke(2));
                g.drawOval(x + (4 * width) / 4, y + width - 15, 30, 30);
                g.setColor(Color.red);
                g.drawLine(x + (5 * width) / 4 - 2, y + width, x + (6 * width) / 4 - 2, y + width);
                g.drawLine(x + (7 * width) / 4 + 7, y + width, x + (8 * width) / 4 + 7, y + width);
                g.drawLine(x + (7 * width) / 4 + 9, y + width - 3, x + (7 * width) / 4 + 9, y + width + 3);
                //	g.drawLine(x +(5*width)/4  , y + width /2, x + (5*width)/4 ,y + (3*width)/2);
                //	g.drawLine(x +(7*width)/4  , y + width /2, x + (7*width)/4 ,y + (3*width)/2);
                g.setStroke(new BasicStroke(4));
                // end points 
                g.setColor(Color.red);
                g.fillRect(x - 4, y + width - 4, 8, 8);
                g.fillRect(x + 3 * width - 3, y + width - 4, 8, 8);
                g.rotate(-angle, x, y);

            }

            void draw_current(Graphics2D g, int x, int y, int width, double angle) {
                g.rotate(angle, x, y);
                g.setColor(Color.yellow);
//				g.drawRect( x , y , 3*width , 2*width);
                ...
                g.setStroke(new BasicStroke(4));
                g.drawLine(x, y + width, x + (4 * width) / 4, y + width);
                g.drawLine(x + 3 * width, y + width, x + (8 * width) / 4, y + width);

                g.drawOval(x + (4 * width) / 4, y + width - 10, 20, 20);
                g.drawLine(x + (5 * width) / 4, y + width, x + (7 * width) / 4, y + width);
                g.drawLine(x + (7 * width) / 4, y + width, x + (7 * width) / 4 - 5, y + width - 5);
                g.drawLine(x + (7 * width) / 4, y + width, x + (7 * width) / 4 - 5, y + width + 5);
...
URL tempfile = null;
            ...
            //String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Resistance + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq);
            URL CGIurl = null;
            ...
            public void make_graph() {
                ...
                try {
                    ...
                    while ((line = bf.readLine()) != null) {
                        ...
                        line = bf.readLine();
                        line = bf.readLine();
                        V_out[i] = -1*Double.parseDouble(line.split(",")[0]);
                        line = bf.readLine();
                        line = bf.readLine();
            ...
            public String strPre(double inValue) {
                DecimalFormat threeDec = new DecimalFormat("0");
            ...
            public void paint(Graphics g) {
               ...
               /* g2d.setColor(Color.lightGray);
                ...
                for (i = 0; i < no_values - 1; i++) {
                    g2d.drawLine(40 + 2 * i, 400 - (int) Math.round(V_out[i] * 1000), 40 + 2 * (i + 1), 400 - (int) Math.round(V_out[i + 1] * 1000));
                }
System.out.println("Idhar paunch gaya");
                /*   URL tempfile = null;
                URLConnection cn = null;
                //String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Resistance + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq);
                URL CGIurl = null;*/
                try {
                    //  if (exp_type == 0) {
                    tempfile = new URL(getDocumentBase(), "myfile.php");
                ...
                try {
                    ...
                    int ii;
                    String encode1;
                    for (ii = 0; ii < no_values - 1; ii++) {
                        encode1 = "val=" + URLEncoder.encode(String.valueOf(time[ii]) + " " + String.valueOf(V_out[ii]) + "\n");
                        System.out.println(encode1);
                        out.writeBytes(encode1);
                    }
                    out.flush();
                    out.close();
                    ...
                    BufferedReader in1 =
                            new BufferedReader(new InputStreamReader(cn.getInputStream()));
                ...
                g2d.setColor(Color.black);
               /* for (i = 0; i < no_values - 1; i += 15) {
                    DecimalFormat df = new DecimalFormat("##.## ");
                    g2d.drawString(strPre(time[i] / 10000000), 40 + 2 * i, 450);
                }

		i=1;
                while(i<no_values-1) {
                    DecimalFormat df = new DecimalFormat("##.## ");
		    if(!(strPre(V_out[i]*10000).equals(strPre(V_out[i-1]*10000))))
		    {
                    g2d.drawString(strPre(V_out[i] * 10000), 40, 490 - 2 * i);
		    i+=10;
		    }
		    i++;
                }*/
		...
		for(i=0;i<10;i++)
		{
			g2d.drawString(strPre((time[1]/10000000)+1*(i+1)),40+30*(i+1),450);
		}
		for(i=0;i<10;i++)
		{
			g2d.drawLine(40+30*(i+1),440,40+30*(i+1),435);
		}
		for(i=0;i<15;i++)
		{
			g2d.drawString(strPre(V_out[1]*1000+1*(i+1)),25,450-30*(i+1));
		}
		for(i=0;i<15;i++)
		{
			g2d.drawLine(35,450-30*(i+1),40,450-30*(i+1));
		}
                g2d.setColor(Color.black);
                g2d.setStroke(new BasicStroke(1));
                ...
                g2d.setColor(Color.blue);
                g2d.drawString("log(f) (Hz) --> ", 160, 460);
                g2d.drawString("Vdb ", 5, 200);
                g2d.drawString("(volt) ", 5, 213);
...
// setting work panel -----------------------------------
            ...
            for (i = 1; i <= 6; i++) {
                java.net.URL imgURL = getClass().getResource("images4/comp" + i + ".jpg");
                if (imgURL != null) {
            ...
            for (i = 1; i <= 6; i++) {
                ...
                java.net.URL imgURL = getClass().getResource("images4/comp" + j + ".jpg");
                if (imgURL != null) {
            ...
            URL selected_URL = getClass().getResource("images4/comp" + 0 + ".gif");
            ...
            JLabel temp = new JLabel("<html> <FONT color=white size=6 ><b>Circuit Elements<b/><font/><html/>");
            temp_pp.add(temp);
            temp_pp.setBackground(Color.magenta);
            ...
            selected.setBorder(BorderFactory.createTitledBorder(" SELECTED COMPONENT "));
            toolPanelDown.setBorder(BorderFactory.createTitledBorder(" AVAILABLE COMPONENTS "));
            toolPanelDown.setBackground(Color.cyan);
...
//			JLabel wave_head = new JLabel("This is the wave simulation output");
            ...
            rightPanel.add(wave_head, BorderLayout.SOUTH);
            waveRightPanel.setBackground(Color.cyan);
            JPanel notes = new JPanel();
            JLabel note_head = new JLabel("<html><FONT COLOR=black SIZE=6>NOTES</FONT></html>", JLabel.CENTER);
            rightPanel.add(notes, BorderLayout.NORTH);
            //rightPanel.add();
            notes.add(note_head, BorderLayout.NORTH);
            notes.setBackground(Color.white);

            JSplitPane notesSplitPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT, notes, waveRightPanel); // spliting left in tool & work
            notesSplitPane.setOneTouchExpandable(true); // this for one touch option 
            notesSplitPane.setDividerLocation(0.1);
            rightPanel.add(notesSplitPane, BorderLayout.CENTER);

            JTextArea jTextField1 = new JTextArea();
            Dimension dim = new Dimension(200, 80);
            jTextField1.setPreferredSize(dim);
            // Add label to west
            notes.add(jTextField1, BorderLayout.CENTER);
            jTextField1.append("It WORKS  "+Nmos_l); 
...
// Setting Center  Split ============================================================
            ...
            splitPane.setDividerLocation(1284);
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 >Design and characterization of differential amplifier (a source coupled pair)</FONT></html>", JLabel.CENTER);
            heading.setBorder(BorderFactory.createEtchedBorder(Color.black, Color.black));
            ...
            java.net.URL imgURL = getClass().getResource("images2/simulate1.png");
            java.net.URL imgURL2 = getClass().getResource("images2/graph.gif");
...
//			bottom.add(h );
        ...
        public boolean circuit_check() {
            int check_points_value[][] = new int[24][10]; // each index will store corresponding  component for points of (comp point no -> index )
            ...
            if (exp_type == 0) // Complementary 
            {
                ...
                while (check_points_value[0][l] != -1) {
                    if (check_points_value[0][l] != 10 && check_points_value[0][l] != 3 && check_points_value[0][l] != 4) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[2][l] != -1) {
                    if (check_points_value[2][l] != 13 && check_points_value[2][l] != 14) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[3][l] != -1) {
                    if (check_points_value[3][l] != 0 && check_points_value[3][l] != 10 && check_points_value[3][l] != 8) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[4][l] != -1) {
                    if (check_points_value[4][l] != 0 && check_points_value[4][l] != 10 && check_points_value[4][l] != 8) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[5][l] != -1) {
                    if (check_points_value[5][l] != 10 && check_points_value[5][l] != 7) {
                        return false;
                    }
                    l++;
                }
                ...
                l = 0;
                while (check_points_value[6][l] != -1) {
                    if (check_points_value[6][l] != 10 && check_points_value[6][l] != 7) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[8][l] != -1) {
                    if (check_points_value[8][l] != 3 && check_points_value[8][l] != 4) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[11][l] != -1) {
                    if (check_points_value[11][l] != 9 && check_points_value[11][l] != 13 && check_points_value[11][l] != 14 && check_points_value[11][l] != 7) {
                        return false;
                    }
                    l++;
                }
                ...
                l = 0;
                while (check_points_value[12][l] != -1) {
                    if (check_points_value[12][l] != 9 && check_points_value[12][l] != 13 && check_points_value[12][l] != 14 && check_points_value[12][l] != 7) {
                        return false;
                    }
                    l++;
                }
                ...
                while (check_points_value[13][l] != -1) {
                    if (check_points_value[13][l] != 11 && check_points_value[13][l] != 12 && check_points_value[13][l] != 2 && check_points_value[13][l] != 7) {
                        return false;
                    }
                    l++;
                }
                ...
                l = 0;
                while (check_points_value[14][l] != -1) {
                    if (check_points_value[14][l] != 11 && check_points_value[14][l] != 12 && check_points_value[14][l] != 2 && check_points_value[14][l] != 7) {
                        return false;
                    }
                    l++;
                }*/
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (/*Nmos_l != null && Nmos_w != null && Resistance_1 != null && Resistance_2 != null && DC_vol != null && AC_vol != null && AC_freq != null &&*/ circuit_check()) {
                    //		callJS();
                    URL php_file = null;
                    URLConnection c = null;
                    String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Resistance_1 + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq + "_" + Nmos_l_2 + "_" + Nmos_w_2 + "_" + Nmos_l_3 + "_" + Nmos_w_3 +"_"+Nmos_l_4+"_"+Nmos_w_4+"_"+Resistance_2);
                    URL CGIurl = null;
                    try {
                        if (exp_type == 0) {
                            php_file = new URL(getDocumentBase(), "myFile.php");
                            System.out.println(php_file.toString());
                    ...
                    waveRightPanel.repaint();
                     java.net.URL uri2 = getClass().getResource("img.html");
                     getAppletContext().showDocument(uri2, "_blank");
