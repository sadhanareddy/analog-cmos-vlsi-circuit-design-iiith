...
fwrite($f , "vin1 in1 0 ac $comp_value[5]m dc $comp_value[4]\n"); 
fwrite($f , "vin2 in2 0 ac -$comp_value[5]m dc $comp_value[4]\n");
//fwrite($f , "vdc in2 0 $comp_value[4]\n");
fwrite($f , ".ac dec 50 10meg 10000meg\n");
fwrite($f , ".save ac V(out1) V(in1)\n");
fwrite($f , ".end\n");
fclose($f);
echo "Done";
//-----------------------------------------------------
