...
public class exp1 extends JApplet {
    ...
    public class MyPanel extends JPanel implements ActionListener, MouseMotionListener {
        ...
        String[] comp_str = { // This will store what should at the Dialog Box for each component
            ...
            "INPUT ", "DC Vol ", "AC Vol ", // 4 , 5 ,6

            "2nd NMOS", "Capacitor", "Vdd ", // 7 , 8 , 9 
            "OUTPUT", "Current Src ", "3rd NMOS ", // 10, 11 , 12
            "This is CMOS Chip No:1", "This is CMOS Chip No:1"};
        //*************************************************************************************************************************************
        //Circuit Component values which need to be send to ngspice ***************************************************************************
        String Pmos_l = "180n";
        String Pmos_l_2 = "180n";
        String Pmos_w = "90000n";
        String Pmos_w_2 = "30000n";
        String Nmos_l = "180n";
        String Nmos_w = "90000n";
        String Capacitance = "1";
        String Resistance = "1"; //Actually current
        String AC_vol = "10";
        String AC_freq = ".5G";
        String DC_vol = "1.1";
        String current = "1";
        ...
        public class node {
            ...
            public void make_end_points(int img) {
                ...
                } else if (img == 8 || img == 5 || img == 6 || img == 11) // Capacitor
                {
                    count_end_points = 2;
                    int a, b, c, d;
                    a = 0;
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            public myDialog(JFrame fr, String comp, int node_no) {
                ...
                if (comp_node[node_no].img_no == 8) // capacitor 
                {
                    ...
                    JLabel c_unit = new JLabel("picofarad");
                ...
                {
                    SpinnerModel resistance_model = new SpinnerNumberModel(1, //initial value
                            0, //min
                            100, //max
                            0.1);  //step
                    JLabel comp_name = new JLabel("<html><font size=4><b>" + comp + "</b></font></html>");//,icon[icon_no],JLabel.CENTER);
                ...
                } else if (comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9) // terminal
                {
                    ...
                    del.addActionListener(this);
                    rotate.addActionListener(this);
                } else if (comp_node[node_no].img_no == 1 || comp_node[node_no].img_no == 7 || comp_node[node_no].img_no == 12)// NMOS chip 
                {
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource() == ok) {
                    ...
                    } else if (comp_node[node_index].img_no == 7) //NMOS
                    {
                        Nmos_l = get_length();
                        Nmos_w = get_width();
                    } else if (comp_node[node_index].img_no == 12) //2nd PMOS
                    {
                        Pmos_l_2 = get_length();
                        Pmos_w_2 = get_width();
                    ...
                    } else if (comp_node[node_index].img_no == 11) //Resistance
                    {
            ...
            public void mouseClicked(MouseEvent me) {
                ...
                if (img_button_pressed == -1) // for selecting anything on work panel
                {
                    ...
                    } else if (work_mat[work_x][work_y] != -1) // there is a comp on (work_x , work_y) here temp rep inder of comp_nodearray
                    {
                        ...
                        if (temp1 == 1 || temp1 == 7 || temp1 == 8 || temp1 == 2 || temp1 == 9 || temp1 == 12 || temp1 == 5 || temp1 == 6 || temp1 == 11) {
                ...
                } else // For adding comp 
                {
                    ...
                    if (img_button_pressed == 1 || img_button_pressed == 7 || img_button_pressed == 12) // cmos or nmos 
                    {
                    ...
                    } else if (img_button_pressed == 8 || img_button_pressed == 5 || img_button_pressed == 6 || img_button_pressed == 11) // capicitor  
                    {
...
URL tempfile = null;
            ...
            public void paint(Graphics g) {
               ...
               /* g2d.setColor(Color.gray);
                ...
                for (i = 0; i < no_values - 1; i++) {
                    g2d.drawLine(40 + 2 * i, 400 - (int) Math.round(V_out[i] * 10000), 40 + 2 * (i + 1), 400 - (int) Math.round(V_out[i + 1] * 10000));
                }
System.out.println("Idhar paunch gaya");
             ...
             /*   for (i = 0; i < no_values - 1; i += 15) {
                ...
                for (i = 0; i < no_values - 1; i += 15) {
                    DecimalFormat df = new DecimalFormat("##.## ");
                    g2d.drawString(strPre(V_out[i] * 10000), 40, 40 + 2 * i);
                }*/
		double prin,unit=Double.valueOf(strPre(time[1]/10000000).trim()).doubleValue();
		for(i=0;i<10;i++)
		{
		...
		for(i=0;i<15;i++)
		{
			g2d.drawString(strPre(7+.1*i),22,450-30*(i+1));
		}
		for(i=0;i<15;i++)
		{
			g2d.drawLine(35,450-30*(i+1),40,450-30*(i+1));
                ...
                g2d.drawString("Vdb ", 3, 200);
                g2d.drawString("(mV) ", 3, 213);
...
//			JLabel wave_head = new JLabel("This is the wave simulation output");
            ...
            jTextField1.append("It WORKS  "+Pmos_l); 
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=6 >Design and characterization of a voltage-mode buffer and a current-mode buffer </FONT></html>", JLabel.CENTER);
...
//			bottom.add(h );
        ...
        public boolean circuit_check() {
            int check_points_value[][] = new int[21][10]; // each index will store corresponding  component for points of (comp point no -> index )
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (Pmos_l_2 != null && Pmos_l != null && Pmos_w_2 != null && Pmos_w != null && Nmos_l != null && Nmos_w != null && Capacitance != null && DC_vol != null && AC_vol != null && AC_freq != null && circuit_check()) {
                    //		callJS();
                    URL php_file = null;
                    URLConnection c = null;
                    String encoded = "comp=" + URLEncoder.encode(Nmos_l + "_" + Nmos_w + "_" + Capacitance + "_" + Resistance + "_" + DC_vol + "_" + AC_vol + "_" + AC_freq + "_" + Pmos_l + "_" + Pmos_w + "_" + Pmos_l_2 + "_" + Pmos_w_2);
                    URL CGIurl = null;
                    try {
                        if (exp_type == 0) {
