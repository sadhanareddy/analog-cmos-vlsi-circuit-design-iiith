...
fwrite($f , "M1 Vdd in out 0 NMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "cl out 0 $comp_value[2]p\n");
fwrite($f , "M2 out Vb 0 0 NMOS l=$comp_value[7] w=$comp_value[8]\n"); 
fwrite($f , "M3 Vb Vb 0 0 NMOS l=$comp_value[9] w=$comp_value[10]\n"); 
fwrite($f , "Ib Vdd Vb $comp_value[3]m\n");
fwrite($f , "Vdd Vdd 0 1.8\n");
fwrite($f , "vin in 0 ac $comp_value[5]m dc $comp_value[4]\n"); 
fwrite($f , ".ac dec 50 10meg 1000meg\n");
fwrite($f , ".save Vdb(out) V(in)\n");
fwrite($f , ".end\n");
fclose($f);
echo "Done";
//-----------------------------------------------------
