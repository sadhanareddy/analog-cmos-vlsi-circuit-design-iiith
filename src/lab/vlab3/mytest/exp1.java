...
//			bottom.add(h );
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (true) {//Nmos_l != null && Nmos_w != null && Capacitance != null && Resistance != null && DC_vol != null && AC_vol != null && AC_freq != null && circuit_check()) {//MATCH
                    //		callJS();
                    URL php_file = null;
                ...
                /*    try {
                        try {
                            System.out.println("\nEVERYTHING FINE");
                            URI myURI = new URI("http://localhost/vlab/mytest/obj.html");
