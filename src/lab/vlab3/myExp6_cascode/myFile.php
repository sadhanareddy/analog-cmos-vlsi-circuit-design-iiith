...
fwrite($f , "M1 out1 vb 0 0 NMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "M2 vb vb 0 0 NMOS l=$comp_value[7] w=$comp_value[8]\n");
fwrite($f , "M3 out vb1 out1 0 NMOS l=$comp_value[9] w=$comp_value[10]\n"); 
fwrite($f , "M4 vb1 vb1 vb 0 NMOS l=$comp_value[11] w=$comp_value[12]\n"); 
