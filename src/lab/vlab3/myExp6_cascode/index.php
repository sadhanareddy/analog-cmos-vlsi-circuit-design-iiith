...
if(!isset($_GET["section"])) $section = "Introduction and Theory"; 
...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse30/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse30/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse30/vlab3/myExp6_cascode/index.php";
$base_url = $exp_url;
