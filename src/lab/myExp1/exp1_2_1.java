...
public class exp1_2_1 extends JApplet {
        ...
        public class myDialog extends JDialog implements ActionListener {
            ...
            public myDialog(JFrame fr, String comp, int node_no) {
                ...
                } /*else if (comp_node[node_no].img_no == 11) // current 
                {
                    ...
                    del.addActionListener(this);
                    rotate.addActionListener(this);
                } */else if (comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9 || comp_node[node_no].img_no == 1 || comp_node[node_no].img_no == 7 || comp_node[node_no].img_no == 11) // terminal
                {
                    JLabel comp_name = new JLabel("<html><font size=4><b>" + comp + "</b></font></html>");//,icon[icon_no],JLabel.CENTER);
            ...
            String get_voltage() {
                return voltage.getValue().toString();
            }
...
////////			int no_values = 100 ;
            ...
            public void make_graph(double Len, double Wid, double Vol) {
                int incr = 0;
                double W = 240;//240.0;
                double L = 180;//180.0;
                double MuCox = .0001;
               // double Id = Cur * 10e-6;
                ...
                for (incr = 0; incr < 100; incr++) {
                    in_V[incr] = (Vgs*2 + incr * .2) * 5;
                    data[incr] = MuCox*(W/L)*(in_V[incr]-0.5) * 500;
                }
//				fileToRead ="outfile";
//				URL url = null;
//				try
...
//			JLabel wave_head = new JLabel("This is the wave simulation output");
	    ...
	    //JPanel notes = new JPanel();
            ...
            //jTextField1.setText("The variation in the transconductance when the aspect ratio is constant is plotted in this graph.\n\nThe transconductance is inversely proportional to the overdrive voltage, when drain current is constant.\n\nThe transconductance is proportional to overdrive voltage when the aspect ratio is constant.");
...
//Setting Top Panel ========================================================================== 
            ...
            JLabel heading = new JLabel("<html><FONT COLOR=WHITE SIZE=10 ><B>Variation of Transconductance (Gm) with Overdrive (Vgs-Vth)</B></FONT></html>", JLabel.CENTER);
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == exp_list) {
                ...
                if (true){//((Pmos_l != null && Pmos_w != null) || (Nmos_l != null && Nmos_w != null)) && Voltage != null && Current != null && circuit_check()) {
                    ...
                    waveRightPanel.make_graph(Double.parseDouble(Pmos_l), Double.parseDouble(Pmos_w), Double.parseDouble(Voltage));// Read file OUTFILE and draw the 
