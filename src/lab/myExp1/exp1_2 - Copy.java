...
//				end_index++;
		...
		public class myDialog extends JDialog implements ActionListener 
		{
			...
			public myDialog (JFrame fr , String comp, int node_no)
			{
				...
				else if ( comp_node[node_no].img_no == 2 || comp_node[node_no].img_no == 9 || comp_node[node_no].img_no == 5 || comp_node[node_no].img_no == 11 ) // terminal
				{
					JLabel comp_name = new JLabel("<html><font size=4><b>"+comp+"</b></font></html>" );//,icon[icon_no],JLabel.CENTER);
...
//			bottom.add(h );
		...
		public void actionPerformed(ActionEvent e )
		{
			...
			else if(e.getSource() == simulate_button )
			{
				...
				if ( Pmos_l != null && Pmos_w != null && Nmos_l != null && Nmos_w != null && circuit_check())
				{
					//		callJS();
					URL php_file =null ;
